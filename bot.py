...
Инлайн-форма для поиска по неполным данным (чистый текст, без эмодзи и форматирования).
"""
...
# ========== ФОРМАТИРОВАНИЕ КРАТКОГО ОТВЕТА (без эмодзи и Markdown) ==========
...
# ========== ФУНКЦИЯ ПОСТРОЕНИЯ ФОРМЫ (без полей, только инструкция) ==========
